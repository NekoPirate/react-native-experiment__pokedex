...
const ScreenLeft = ({ animationValue }) => {
    ...
    return (
        <Page width={SCREEN_WIDTH}>
            ...
            {/*  PDX0  */}
            <View style={[
                { width: SCREEN_WIDTH, height: '100%', position: 'absolute', top: 0 },
                { justifyContent: 'flex-start', alignItems: 'center' },
                // { backgroundColor: '#333' }
            ]}>

                <Image source={require('../assets/img/PDX1.png')} style={styles.IMG} resizeMode={'stretch'} />
            </View>
            ...
            <View pointerEvents='none'
                ...
                <Image source={require('../assets/img/PDX0.png')} style={{ width: SCREEN_WIDTH, height: '100%' }} resizeMode={'stretch'} />
